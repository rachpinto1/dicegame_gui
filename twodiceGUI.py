...
class TwoDiceGUI(Easy Frame):

	# definition of the __init__() method which is our class constructor
	def __init__(self):
		# call the Easy Frame constructor method
		...
		self.playerRoll = self.addIntegerField(value = 0, row = 1, colum = 1, width = 4, state = "readonly")
		# COMPUTER
		...
		self.resultArea = self.addLabel(text = "", row = 4, column = 0, columspan = 2, sticky = "NSEW", background = "SeaGreen", foreground = "white",  font = Font(family = "Georgia", size = 22))
		...
		def roll(self):
            ...
            self.computerRoll.setNumer(die2)
            self.resultArea["text"] = resultArea

# definiton of the main() method which will establish class projects
def main():
